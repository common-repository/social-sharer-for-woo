	...
	class SSFWC_PLUGIN_SETTINGS
	{
	    ...
	    public function __construct()
	    {
	    	$this->PluginSettingsFields = [
				...
				'ssfwc_buttons_shortcode' => [
					'title' 	=> __( 'Shortcode', 'social-sharer-for-woo' ),
					'callback' 	=>'render_buttons_shortcode_field'
				]
			];
	    ...
	    {		
			add_menu_page( __( 'Social Sharer For Woo', 'social-sharer-for-woo' ), __( 'Social Sharing', 'social-sharer-for-woo' ), 'manage_options', 'social-sharer-for-woo', [ $this, 'render_social_sharing' ], 'dashicons-share' );
		}
		...
		public function render_social_sharing()
		{
			...
			<div class="wrap ssfw_social_share_buttons_settings ssfw_social_share_buttons">
			    ...
			    <h2 style="background-image: <?php echo esc_url( $icon ); ?>;background-repeat:  no-repeat;background-position: left 12px;background-size: 25px;padding-left: 30px;">
		...
		public function render_buttons_shortcode_field()
		{
			?>
				<code>[ssfwc_social_sharing_buttons]</code>
			<?php
		}
	}
