...
{
	$( '#ssfwc_buttons_position' ).select2();

	$( '#ssfwc_buttons_icontext_field' ).select2();
	...
	$( '#social_service_toggle_btn' ).click( function( event )
	{
		...
		var values = $( '#ssfwc_buttons_list_field_values' ).val();
	...
	$( '#SSFWC_MODAL .close.save' ).click( function( event )
	{
		$( 'input#ssfwc_buttons_list_field_values' ).val( null );
		...
		$( 'input#ssfwc_buttons_list_field_values' ).val( selected );
	} );
